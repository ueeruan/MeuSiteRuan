        ...
        <>
            ...
            >
                <div className="container mx-auto px-4 flex justify-between items-center">
                    ...
                    {/* Mobile Menu Button */}
                    <button
                        className="md:hidden text-white p-2 rounded-lg hover:bg-white/10 transition-colors z-[110]"
                        onClick={toggleMenu}
            ...
            {/* Mobile Menu Overlay - Outside nav to avoid backdrop-filter issues */}
            <AnimatePresence>
                {isMobileMenuOpen && (
                    <motion.div
